...
public class HomeFragment extends Fragment {
    ...
    RecyclerView recyclerViewfav,rvpopuler,rvtrending;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        songAdapter = new SongAdapter(context, listsong);
        recyclerViewfav.setAdapter(songAdapter);
        ...
        //set data and list adapter
        songAdapter = new SongAdapter(context, listsong);
        rvpopuler.setAdapter(songAdapter);
        ...
        //set data and list adapter
        songAdapter = new SongAdapter(context, listsong);
        rvtrending.setAdapter(songAdapter);
    ...
    private void getListSong(){
        listsong.clear();
        for (int i = 0; i <10 ; i++) {
            listsong.add(new ModelSong("Money On My...","Sam Smitch"));
        }
        songAdapter.notifyDataSetChanged();
        Log.e("logsong", "getListSong: "+listsong );
    }
}